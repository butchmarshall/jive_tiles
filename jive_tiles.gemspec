...
require "jive_tiles/version"

# Describe your gem and declare its dependencies:
Gem::Specification.new do |s|
	s.name        = "jive_tiles"
	s.version     = JiveTiles::VERSION
	s.authors     = ["Butch Marshall"]
	s.email       = ["butch.a.marshall@gmail.com"]
	s.homepage    = "https://github.com/butchmarshall/jive_tiles"
	s.summary     = "Rails Engine for handling Jive tiles."
